...
* **📐 Precise Dimension Sizing**: Enter a target **Width (px)**, **Height (px)**, or both. If only one input is provided, the other scales proportionally. If both are defined, the engine resizes every image to exactly those dimensions, stretching if needed and ignoring aspect ratio completely.
* **💪 Full Upscaling & Orientation Support**: Small and portrait/vertical images are resized exactly to the requested target dimensions without being skipped, ignored, cropped, or rotated.
